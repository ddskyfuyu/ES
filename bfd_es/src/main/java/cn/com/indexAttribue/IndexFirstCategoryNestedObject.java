 ...
 */
public class IndexFirstCategoryNestedObject implements IndexNestedObject {
    ...
    public IndexFirstCategoryNestedObject(IndexFloatAttribute indexFloatAttribute, IndexStringAttribute indexStringAttribute,
    ...
    public void fillNestedObject(JSONObject obj, Map<String, Map<String, String>> value) {
        ...
        for(Map.Entry<String, Map<String, String>> entry : value.entrySet()){
            ...
            if(entry.getKey().equals("String")){
                for(Map.Entry<String, String> subEntry : entry.getValue().entrySet()){
                    if(subEntry.getKey().equals("second_category") || subEntry.getKey().equals("third_category")
                            ||subEntry.getKey().equals("fourth_category") || subEntry.getKey().equals("fifth_category")){
                        continue;
                    }
